...
class Dropdown extends React.Component {
  constructor(props) {
    ...
    this.renderOptions = () => {
      ...
      return options.map(option => {
        ...
        return React.createElement(DropdownItem, { key: option.name, ref: el => el && this.elements.push(el), selected: selected, onOptionClicked: this.onOptionClicked, option: option });
      });
    };
  ...
  render() {
    ...
    return React.createElement(
      ...
      React.createElement(
        'button',
        { id: id, className: dropdownButtonClass, type: 'button', onClick: this.onDropdownClick, disabled: disabled, 'aria-label': displayedValue },
        React.createElement(
          'div',
