...
var OptionItem = React.forwardRef(function (props, ref) {
  ...
  return React.createElement("button", {
    ...
    title: option.title,
    type: "button"
  }, option.iconClass && React.createElement("i", {
...
function defaultOptionRenderer(selectedOption, options, selectedOptionClassName, optionClassName, onOptionClicked, elementsRef, getStyle) {
  return options.map(function (option) {
    ...
    if (groupOptions) {
      ...
      }, React.createElement("div", null, label.toUpperCase()), React.createElement("div", null, groupOptions.length)), option.groupOptions.map(function (groupOption) {
        var groupOptionClass = cx(groupOption.className, getStyle('optionItem', groupOption.value === selectedOption));
    ...
    var optionClass = cx(className, getStyle('optionItem', {
...
function (_Component) {
  ...
  _createClass(Dropdown, [{
    ...
    value: function render() {
      ...
      var dropdownButtonClass = cx(buttonClassName, this.getStyle('dropdownButton'));

      var displayedValueClass = cx(selectedValueClassName, this.getStyle('displayedValue'));

      var contentClass = cx(contentClassName, this.getStyle('optionContainer'));
      ...
      }, displayedValue), !hideArrow && !arrowRenderer && React.createElement("div", {
        className: arrowClass
      }), !hideArrow && arrowRenderer && arrowRenderer(open)), React.createElement("ul", {
  ...
  return Dropdown;
}(Component); // Please Keep Alphabetical
