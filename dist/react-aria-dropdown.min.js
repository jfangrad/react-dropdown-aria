  ...
  return options.map(option => {
    ...
    if (groupOptions) {
      ...
      return React.createElement(
        'div',
        { key: label, className: getStyle('groupContainerStyle') },
        React.createElement(
          'div',
          { className: getStyle('groupHeadingStyle') },
          React.createElement(
            'div',
            null,
            label.toUpperCase()
        ...
        option.groupOptions.map(groupOption => {
          const groupOptionClass = emotion.cx(groupOption.className, getStyle('optionStyle', groupOption.value === selectedOption));
          return React.createElement(
            'button',
            {
    ...
    const optionClass = emotion.cx(className, getStyle('optionStyle', value === selectedOption));
    return React.createElement(
      'button',
      {
...
const optionStyle = (props, state, selected) => ({
  fontSize: '0.95em',
  overflow: 'hidden',
...
class Dropdown extends React.Component {
  ...
  render() {
    ...
    const dropdownButtonClass = emotion.cx(buttonClassName, this.getStyle('dropdownButtonStyle'));
    const displayedValueClass = emotion.cx(selectedValueClassName, this.getStyle('displayedValueStyle'));
    const contentClass = emotion.cx(contentClassName, this.getStyle('optionContainerStyle'));
