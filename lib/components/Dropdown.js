    ...
    function Dropdown(props) {
        ...
        _this.renderValue = function () {
            ...
            if (multi) {
                ...
                return (react_1.default.createElement("div", { className: displayedValueClass }, (selectedOption || internalSelectedOption || []).map(function (option) { return (react_1.default.createElement(Tag_1.default, { value: option, key: option, onDeleteClick: _this.handleOptionRemove })); })));
            }
        ...
        _this.onOptionClicked = function (_a) {
            ...
            if (nativeEvent.target) {
                ...
                _this.setState({ open: false, internalSelectedOption: newSelectedOption });
